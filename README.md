...
This is a working-in-progress for creating a library based on TinyGSM to support _only_ NB-IOT/CAT-M1 modules with latest AT command sets than using the lagacy GPRS APIs.
<!---
